...
def tweet_to_telegram(tweet_json, username):
    ...
    tweet_id = tweet_content.get('id_str')
    ...
    text = html.escape(tweet_content.get('full_text', ''))
    caption = f"🚨 <b>New Tweet by @{username}</b>\n\n{text}\n\n🔗 <a href='{tweet_url}'>View on X</a>"
    ...
    try:
        ...
        if media:
            requests.post(
                ...
                data={"chat_id": CHAT_ID, "photo": media, "caption": caption, "parse_mode": "HTML"}, 
